      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            // 3.1 KEAMANAN: KUNCI SIDIK JARI (FINGERPRINT LOCK)
            if (authProvider.isAuthenticated && user != null) ...[
              Container(
                decoration: BoxDecoration(
                  color: Colors.white,
                    ...
                    children: [
                      Container(
                        ...
                        child: Icon(
                          ...
                          color: user.biometricEnabled ? const Color(0xFF0891B2) : const Color(0xFF64748B),
                          size: 22,
                        ),
                      ),
                      const SizedBox(width: 12),
                          ...
                          children: [
                            ...
                            Text(
                              user.biometricEnabled
                                  ? 'Aktif • Minta sidik jari saat membuka aplikasi'
  ...
  Future<void> _handleToggleBiometric(
    ...
    if (newVal) {
      ...
      try {
        ...
        if (!canCheck && !isSupported) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Perangkat Anda belum mendukung sensor sidik jari.'),
        ...
        final bool authenticated = await localAuth.authenticate(
          localizedReason: 'Sentuh sensor sidik jari Anda untuk mengonfirmasi pengaktifan kunci aplikasi',
        ...
        if (!authenticated) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Verifikasi sidik jari dibatalkan. Kunci belum diaktifkan.'),
              behavior: SnackBarBehavior.floating,
            ),
          );
          return;
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Kendala sensor sidik jari: $e'),
    ...
    if (success) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            newVal ? 'Kunci Sidik Jari Berhasil Diaktifkan! 🔐' : 'Kunci Sidik Jari Telah Dinonaktifkan.',
          ),
