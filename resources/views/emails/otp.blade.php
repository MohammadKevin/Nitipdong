...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            @if($type === 'register')
                <p>Terima kasih telah mendaftar di <strong>NitipDong</strong>. Untuk mengamankan akun Anda, silakan gunakan kode OTP berikut untuk menyelesaikan proses pendaftaran.</p>
            @else
                <p>Anda menerima email ini karena ada permintaan untuk mengubah alamat email pada akun <strong>NitipDong</strong> Anda. Silakan masukkan kode OTP berikut untuk melanjutkan.</p>
            @endif
        ...
        <div class="footer">
            <p>&copy; {{ date('Y') }} NitipDong. Hak Cipta Dilindungi.</p>
        </div>
    </div>
</body>
</html>
